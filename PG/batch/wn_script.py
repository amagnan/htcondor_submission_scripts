...
def main():
    parser = argparse.ArgumentParser(
        description="Run FairShip simScript simulation with environment setup"
    )
    ...
    source "{INIT_SCRIPT}"
    source "{FS_INSTALL}/htcondor_submission_scripts/PG/batch/test_config.sh"
    which python
    export FAIRROOT_HASH="b94d9ef82bcf45eeb876b661b9bdfd4c6ab549c2"
